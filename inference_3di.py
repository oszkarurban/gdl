...
Usage:
    python inference_3di.py --checkpoint results/llm_3di --test_file data/tokenized3/test.jsonl
    python inference_3di.py --zero_shot --test_file data/tokenized3/test.jsonl

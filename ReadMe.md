...
Note that we renamed **ProDesign** to **PiFold** to avoid naming conflicts with previous work. Our new method [knowledge-design](https://arxiv.org/abs/2305.15151) outperforms PiFold about 9%, the code has been released [here](https://github.com/A4Bio/OpenCPD).
